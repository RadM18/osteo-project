=== Rus filename translit ===
Contributors: fixed77
Donate link: http://fixed77.ru
Tags: filename, translit
...
1.	Download the Wordpress russian filename translitter archive in zip or gzipped tar format and
	extract the files on your computer. 

2.	Copy  `rufilenametranslit` in the `wp-content/plugins`
...
3.	Log in to the WordPress Dashboard and activate the Wordpress Rus filename translit plugin.
